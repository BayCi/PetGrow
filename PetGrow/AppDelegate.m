...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [defaults setValue:isUser forKey:@"key"];
    [defaults synchronize];
    
    self.window.backgroundColor = [UIColor whiteColor];
    UIImageView *background = [[UIImageView alloc]initWithFrame:CGRectMake(0, 88, 375, 690)];
    background.backgroundColor = [self colorWithHexString:@"#fff4e1" alpha:1.0];
    [self.window addSubview:background];
    Choose_ViewController *Chv = [[Choose_ViewController alloc]init];
    UINavigationController *Choose = [[UINavigationController alloc]initWithRootViewController:Chv];
    self.window.rootViewController = Choose;
//    Award_ViewController *aw = [[Award_ViewController alloc]init];
//    self.window.rootViewController = aw;
    return YES;
}
